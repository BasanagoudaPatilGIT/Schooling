    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree"> 
		...
		<li class="treeview"><a href="#"><i class="fa fa-book"></i> <span>Subjects</span></a>
          <ul class="treeview-menu">
		  <?php foreach ($class_list as $row): ?>
		  <li><a href="<?php echo base_url()?>Subjects/subject_details/<?php echo $row['id']?>"> <span><?php echo $row['class_name']; echo " - "; echo $row['class_section']?></span></a></li>
           <?php endforeach ?>
		  </ul>
        </li>
		...
		<li><a href="<?php echo base_url()?>Classes/teacher_assignment"><i class="fa fa-th"></i> <span>Class Management</span></a></li>
